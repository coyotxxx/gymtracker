...
private fun MuscleGroup.maskAsset(): String? = when (this) {
    MuscleGroup.CHEST -> "muscle_masks_v2/mask_chest.webp"
    MuscleGroup.BACK -> "muscle_masks_v2/mask_back.webp"
    MuscleGroup.SHOULDERS -> "muscle_masks_v2/mask_shoulders.webp"
    MuscleGroup.BICEPS -> "muscle_masks_v2/mask_biceps.webp"
    MuscleGroup.TRICEPS -> "muscle_masks_v2/mask_triceps.webp"
    MuscleGroup.QUADS -> "muscle_masks_v2/mask_quads.webp"
    MuscleGroup.HAMSTRINGS -> "muscle_masks_v2/mask_hamstrings.webp"
    MuscleGroup.GLUTES -> "muscle_masks_v2/mask_glutes.webp"
    MuscleGroup.CALVES -> "muscle_masks_v2/mask_calves.webp"
    MuscleGroup.CORE -> "muscle_masks_v2/mask_core.webp"
...
private fun BodyHeatmap(analyses: List<MuscleAnalysis>) {
    Box(
        ...
        AsyncImage(
            model = "file:///android_asset/muscle_masks_v2/body_base_v2.webp",
