...
**Postęp:** 28 / 41 zadań
**Następne zadanie:** 3.4 Dieta core (Diet, DietOnboarding, MealPreferences)
...
| 2026-05-15 | 3.3 | ExerciseSnapshotTest — ExerciseLibrary (193 ćwiczeń), ExercisePicker, ExerciseDetail (przez SavedStateHandle). | (ten commit) |
